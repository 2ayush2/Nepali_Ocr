...
if __name__ == "__main__":
    # Use the preprocessed image from the previous pipeline
    image_path = "output/processed_sample2.jpg"  # Link to the preprocessed image
    weights_path = "weights/pan_exp/weights/best.pt"
    output_image_path = "output/annotated_sample2.jpg"  # Unique output image name
    output_json_path = "output/ocr_results_sample2.json"  # Unique JSON output name
    run_ocr(image_path, weights_path, output_image_path, output_json_path)
